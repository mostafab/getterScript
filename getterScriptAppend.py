#This script goes through a Java file and appends all the needed getter methods
#for **private** instance variables into that Java file. 

#Command-line version, appends to a java-file. 
...
newGetters = open(str(fileName), "a")

def getterScriptAppend():
